...
(fs.readFileSync('./datapack/data/reforger/loot_tables/netherite_sword.json', 'utf8') ?? '') && ['diamond_sword', 'golden_sword', 'iron_sword', 'stone_sword', 'wooden_sword'].forEach(loot_table => {
