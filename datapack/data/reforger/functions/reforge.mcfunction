...
execute at @e[type=minecraft:falling_block,nbt={BlockState: {Name: "minecraft:anvil"}}] positioned ~ ~-1 ~ as @e[type=item_frame,limit=1,distance=..1,sort=nearest,nbt={Facing: 1b, Item: {id: "minecraft:wooden_sword", tag: {CustomModelData: 0}}},tag=saved] if block ~ ~-1 ~ smithing_table unless entity @s[nbt={Item: {tag: {reforged: 1b}}}] run data modify entity @s Item.tag merge value {reforged: 0b}
execute at @e[type=minecraft:falling_block,nbt={BlockState: {Name: "minecraft:anvil"}}] positioned ~ ~-1 ~ as @e[type=item_frame,limit=1,distance=..1,sort=nearest,nbt={Facing: 1b, Item: {id: "minecraft:stone_sword", tag: {CustomModelData: 0}}},tag=saved] if block ~ ~-1 ~ smithing_table unless entity @s[nbt={Item: {tag: {reforged: 1b}}}] run data modify entity @s Item.tag merge value {reforged: 0b}
execute at @e[type=minecraft:falling_block,nbt={BlockState: {Name: "minecraft:anvil"}}] positioned ~ ~-1 ~ as @e[type=item_frame,limit=1,distance=..1,sort=nearest,nbt={Facing: 1b, Item: {id: "minecraft:iron_sword", tag: {CustomModelData: 0}}},tag=saved] if block ~ ~-1 ~ smithing_table unless entity @s[nbt={Item: {tag: {reforged: 1b}}}] run data modify entity @s Item.tag merge value {reforged: 0b}
execute at @e[type=minecraft:falling_block,nbt={BlockState: {Name: "minecraft:anvil"}}] positioned ~ ~-1 ~ as @e[type=item_frame,limit=1,distance=..1,sort=nearest,nbt={Facing: 1b, Item: {id: "minecraft:golden_sword", tag: {CustomModelData: 0}}},tag=saved] if block ~ ~-1 ~ smithing_table unless entity @s[nbt={Item: {tag: {reforged: 1b}}}] run data modify entity @s Item.tag merge value {reforged: 0b}
execute at @e[type=minecraft:falling_block,nbt={BlockState: {Name: "minecraft:anvil"}}] positioned ~ ~-1 ~ as @e[type=item_frame,limit=1,distance=..1,sort=nearest,nbt={Facing: 1b, Item: {id: "minecraft:diamond_sword", tag: {CustomModelData: 0}}},tag=saved] if block ~ ~-1 ~ lodestone unless entity @s[nbt={Item: {tag: {reforged: 1b}}}] run data modify entity @s Item.tag merge value {reforged: 0b}
execute at @e[type=minecraft:falling_block,nbt={BlockState: {Name: "minecraft:anvil"}}] positioned ~ ~-1 ~ as @e[type=item_frame,limit=1,distance=..1,sort=nearest,nbt={Facing: 1b, Item: {id: "minecraft:netherite_sword", tag: {CustomModelData: 0}}},tag=saved] if block ~ ~-1 ~ lodestone unless entity @s[nbt={Item: {tag: {reforged: 1b}}}] run data modify entity @s Item.tag merge value {reforged: 0b}
